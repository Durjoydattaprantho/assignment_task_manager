...
class NetworkClient {
  ...
  static Future<NetworkResponse> getRequest({required String url}) async {
    try {
      ...
      if(e is SocketException){
        showPopUp(task_manager.navigatorKey.currentContext, 'Check your internet connection');
      }
  ...
  static Future<NetworkResponse> postRequest({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        showPopUp(task_manager.navigatorKey.currentContext, errorMessage,true);
        return NetworkResponse(
            isSuccess: false,
            statusCode: response.statusCode,
            data: decodedJson,
      ...
      if(e is SocketException){
        ...
        showPopUp(task_manager.navigatorKey.currentContext,'Try with a small size image');
      }
  ...
  static _moveToLoginScreen() {
    Navigator.pushNamedAndRemoveUntil(
      task_manager.navigatorKey.currentContext!,
      '/login',
          (route) => false,
    );
  }
